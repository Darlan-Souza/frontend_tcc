...
$.fn.bic_calendar = function(options) {
    ...
    this.each(function() {
        ...
        function showCalendar() {
            ...
            var nextMonthButton = $('<td><a href="#" class="button-month-next"><button class="btn btn-primary"><i class="fa fa-arrow-circle-right" ></i></button></a></td>');
            //event
            ...
            var previousMonthButton = $('<td><a href="#" class="button-month-previous"><button class="btn btn-primary"><i class="fa fa-arrow-circle-left" ></i></button></a></td>');
            //event
            ...
            var nextYearButton = $('<td><a href="#" class="button-year-next"><button class="btn btn-primary"><i class="fa fa-arrow-circle-right" ></i></button></a></td>');
            //event
            ...
            var previousYearButton = $('<td><a href="#" class="button-year-previous"><button class="btn btn-primary"><i class="fa fa-arrow-circle-left" ></i></button></a></td>');
            //event
        ...
        function listListeralsWeek() {
            if (showDays != false) {
                var capaDiasSemana = $('<tr class="days-month" align="center">');
                var codigoInsertar = '';
        ...
        function showMonthDays(month, year) {
            ...
            for (var i = 0; i < 7; i++) {
                if (i < firstDay) {
                    ...
                    //add weekDay
                    dayCode += ' class="day week-day-' + i + '" align="center"';
            ...
            while (daysCounter <= lastDayMonth) {
                ...
                dayCode += '<td id="' + calendarId + '_' + daysCounter + "_" + nMonth + "_" + year + '" data-date="' + nMonth + "/" + daysCounter + "/" + year + '" ';
                //add weekDay
                dayCode += ' class="day week-day-' + ((currentWeekDay - 1) % 7) + '" align="center"';
